        ...
        imageContainer.innerHTML = `
            <div class="trip-mystery">
                ...
                <div class="countdown-selector">
                    <select id="countdownDuration" class="countdown-select">
                    ...
                    <button class="btn btn-primary" onclick="startCountdown('${trip.id}', document.getElementById('countdownDuration').value)">
...
function startCountdown(tripId, countdownDuration) {
    const trip = getTrip(tripId);
    ...
    // Start countdown
    const countdownSeconds = parseInt(countdownDuration, 10);
...
function loadPopularDestinations() {
    ...
    const featuredDestinations = [
        ...
        },
        {
            ...
            region: 'Asia',
            budget: 'Low Budget',
            image: 'https://images.unsplash.com/photo-1531737212413-667205e1cda7?auto=format&fit=crop&w=800',
